...
function buildTopStyles(container: ContainerRect, props: RenderProps): CSSProperties {
...
function buildBottomStyles(container: ContainerRect, props: RenderProps): CSSProperties {
  const { bottomOffset, hideOnBoundaryHit } = props
...
function buildStickyStyle(mode: StickyMode, props: RenderProps, container: ContainerRect): CSSProperties {
  return (mode === 'top' ? buildTopStyles : buildBottomStyles)(container, props)
}

function isEqual(obj1: State, obj2: State) {
